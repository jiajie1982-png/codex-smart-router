...
$taskScript = Join-Path $PSScriptRoot 'app.py'
...
[void][System.Windows.Forms.MessageBox]::Show('Install Python 3.10 or later with Tcl/Tk and Codex desktop, then try again. See references/README.md.', 'Smart Model Router')
exit 1
